...
| Проект *.inclproj | DONE | tests/unit/test_project_io.cpp | JSON формат, атомарное сохранение; сохраняет проектные точки, cluster_position, shot_points |
...
| Функция | Статус | Тесты | Примечания |
|--------|--------|-------|------------|
| Главное окно | PARTIAL | - | Список скважин/проектных точек подключён; переключение «Показ» влияет на план/вертикаль; добавление/удаление проектных точек в левой панели |
